...
namespace :'fortitude-rails' do
  ...
  task :install, [:sass_path] do |t, args|
    ...
    FileUtils.mkdir_p("#{Rails.root}/#{args.sass_path}/fortitude")
    FileUtils.cp_r("#{source_root}/app/assets/stylesheets/.", "#{Rails.root}/#{args.sass_path}/fortitude", { :preserve => true })
    Find.find("#{Rails.root}/#{args.sass_path}/fortitude") do |path|
